...
(() => {
  ...
  var EVENT_MAP = {
    ...
    // PATCH local: eventos multi-palabra que faltaban. Sin ellos, al abrir la
    // página vía file:// (doble clic) el fetch del HTML crudo falla, la
    // plantilla se toma del DOM (atributos en minúsculas) y el fallback
    // "on"+mayúscula produce nombres inválidos para React (p.ej. onMousemove)
    // — la lupa de la página de producto dejaba de funcionar.
